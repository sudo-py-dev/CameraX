...
val DarkPrimary = Color(0xFF00BCD4) // Electric Cyan
val DarkSecondary = Color(0xFF7C4DFF) // Electric Violet
val DarkTertiary = Color(0xFFFFAB40) // Warm Amber (capture accents)
val DarkOnBackground = Color(0xFFF1F3F5)
val DarkOnSurface = Color(0xFFE0E2E6)
...
val LightPrimary = Color(0xFF00838F) // Deep Teal
val LightSecondary = Color(0xFF5C6BC0) // Indigo
val LightTertiary = Color(0xFFFF8F00) // Amber
